...
function ChatBox({ messages, loading, t = {}, darkMode, lang, onClear }) {
                ...
                <div className="flex items-center justify-between gap-2 mb-2">
                  ...
                  {msg.type === 'bot' && (
                    <button
                      ...
                      className={`text-xs font-bold px-2 py-1 rounded-lg border transition flex items-center gap-1 ${
                        speakingIdx === idx
  ...
  return (
    <div className={`min-h-screen flex flex-col justify-between transition-colors duration-200 relative ${
      ...
      <main className="max-w-5xl mx-auto w-full px-4 py-6 flex-1">
        ...
        <ChatBox messages={messages} loading={loading} t={t} darkMode={darkMode} lang={lang} onClear={() => setMessages([])} />
